...
| image.repository | string | `"ghcr.io/catenax-ng/product-knowledge/controlplane-memory"` | Which derivate of the agent-enabled edc control-plane to use. One of: [ghcr.io/catenax-ng/product-edc/edc-controlplane-postgresql-hashicorp-vault, ghcr.io/catenax-ng/product-edc/edc-controlplane-postgresql, ghcr.io/catenax-ng/product-edc/edc-controlplane-memory] |
